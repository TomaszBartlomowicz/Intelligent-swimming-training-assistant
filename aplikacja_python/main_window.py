...
class MainWindow(QWidget):
    ...
    def show_training_history(self):
        self.training_history_window = training_history.TrainingHistory()
        self.training_history_window.showFullScreen()
    ...
    def show_connect_to_sensor(self):
        ...
        self.connect_to_sensor_window.setGeometry(x_cord, y_cord, window_width, window_height)
    ...
    def connect_buttons(self):
        ...
        self.training_history_button.clicked.connect(self.show_training_history)
